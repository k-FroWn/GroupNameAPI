...
public class GroupNameApiApplication {
	...
	public static void runCreate(){
		...
		DBFlight.createFlight(1,"Texas","Cali",new Date(2022,12,5),new Date(2022,12,6),"A300",5,25,50);
	...
	public static void runUpdate(){
		...
		DBFlight.updateFlight("mars","earth",new Date(2001,11,11),new Date(2022,12,6),"B52 bomber",500,9000,1,1);
	...
	public static void runSelect(){
		...
		DBFlight.selectOneFlight(1);
		DBFlight.selectFlights();
		DBFlightStatus.selectFlightStatus();
		DBPassengerDetails.selectPassengerDetails(1);
		DBRes.selectOneReservation(1);
		DBRole.selectRole();
	}
